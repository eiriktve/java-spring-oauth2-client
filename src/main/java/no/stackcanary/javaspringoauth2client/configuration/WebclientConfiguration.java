...
public class WebclientConfiguration {
    ...
    private WebClient.Builder getWebClientBuilder(ReactiveClientRegistrationRepository clientRegistrations) {
    ...
    @Bean
    public WebClient webclient(@Value("resource-server-url") String url, @Qualifier("clientRegistrations") ReactiveClientRegistrationRepository clientRegistrations) {
        return getWebClientBuilder(clientRegistrations)
                .baseUrl(url)
                .build();
    }
